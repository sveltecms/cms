...
type SetToAPP = "NAME" | "DB_URL" | "DB_NAME" | "CLOUDINARY_CLOUD_NAME" | "CLOUDINARY_API_KEY" | "CLOUDINARY_API_KEY_SECRET" | "EMAIL" | "PASSWORD"

/** Ask user information */
async function askAndSet(message:string,type:"input"|"confirm",defaultData?:any,setToAPP?:SetToAPP) {
