...
import type { TemplatesNames } from "./types"

const cwd = process.cwd()
const templateNameSearch = process.argv.findIndex(data=>data.includes("--t="))
const templateName:TemplatesNames = templateNameSearch>0 ? process.argv[templateNameSearch].split("--t=")[1].trim() : "none" as any
