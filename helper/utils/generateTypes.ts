...
export default function generateTypes(data:{[key:string]:any},typeName:string,saveToDir:`${string}.ts`){
    fs.writeFileSync(saveToDir,new GenerateTypes(data,typeName).get())
}
